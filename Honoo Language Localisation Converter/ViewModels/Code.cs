...
namespace HonooLanguageLocalisationConverter.ViewModels
{
    ...
    {
        //internal static string CreateCommunityToolkit(InformationEntry information, IList<SectionEntry> sections)
        //{
        ...
        //    builder.AppendLine("        }");
        //    builder.AppendLine();
        //    builder.AppendLine("        #region Default"1);
        //    builder.AppendLine();
        //    builder.AppendLine("        /// <summary>");
        //    builder.AppendLine("        /// Informartion section.");
        //    builder.AppendLine("        /// </summary>");
        ...
        //    builder.AppendLine("        }");
        //    builder.AppendLine();
        //    builder.AppendLine("        #endregion Default"1);
        //    foreach (var section in sections)
        //    {
        //        string sectionNameU = char.ToUpperInvariant(section.Name![0]) + section.Name![1..];
        //        builder.AppendLine();
        ...
        //internal static string CreateNotifyBasic(InformationEntry information, IList<SectionEntry> sections, bool nullSign)
        //{
        //    var builder = new StringBuilder();
        //    builder.AppendLine("using Honoo.Configuration;");
        ...
        //    builder.AppendLine("{");
        //    builder.AppendLine("    /// <summary>");
        //    builder.AppendLine($"    /// Language package class. Binding-notify basic class {(nullSign ? "[.NET 6.0+][With Project field <Nullable>enable</Nullable>]" : "[.NET Framework 4.0+]")}.");
        //    builder.AppendLine("    /// Using single instance <see cref=\"Instance\"/> to visit.");
        ...
        internal static string CreateCode(int codeType, SectionEntry information, IList<SectionEntry> sections)
        {
            ...
            builder.AppendLine($"                this.Informartion.SaveInternal(defaultFields, manager);");
            foreach (var section in sections)
            {
                string sectionNameU = char.ToUpperInvariant(section.Name![0]) + section.Name![1..];
